...
@TeleOp(name="Teleoperado Under Ctrl (field oriented) 14391", group="Linear TesteOp")
public class TesteField extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        private double gyroCalculate () {
            angles = HardwareClassTracao.imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
